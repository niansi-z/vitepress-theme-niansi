...
export async function init(root?: string) {
  intro(c.bold(c.cyan('Welcome to VitePress-Theme-Niansi!')))
  ...
  const options = await group(
    {
      root: async () => {
        ...
        return text({
          message: 'Where should VitePress-Theme-Niansi initialize the config?',
          initialValue: './',
          defaultValue: './',
          validate() {
      ...
      srcDir: async ({ results }: any) => {
        return text({
          message: 'Where should VitePress-Theme-Niansi look for your markdown files?',
      ...
      description: async () => {
        return text({
          ...
          placeholder: 'A VitePress-Theme-Niansi Site',
          defaultValue: 'A VitePress-Theme-Niansi Site'
        })
      },
...
export function scaffold({
  ...
  if (theme === ScaffoldThemeType.DefaultCustom) {
    ...
    filesToScaffold.push('.vitepress/theme/index.js', '.vitepress/theme/style.css', '.vitepress/theme/Layout.vue')
  }
